...
local FormatNumber = require(ReplciatedStorage.Libraries.FormatNumber)
...
local DataStore = ProfileService.GetProfileStore(DataConfig._settings.DataName, DataConfig.Template)
...
function DataService:UpdateLeaderstats(player: Player)
	...
	for i, v in DataConfig.leaderstats do
		if v.Type == "string" then
			...
			Value.Value = FormatNumber.FormatShort(Data[v.DataName])
		end
	end
end
